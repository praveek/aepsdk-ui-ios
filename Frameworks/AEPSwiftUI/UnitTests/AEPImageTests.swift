...
final class AEPImageTests: XCTestCase {
    ...
    func testInit_imageWithUrl() {
        // setup
        let data = [
            Constants.CardTemplate.UIElement.Image.URL: TestConstants.MOCK_URL
        ] as [String : Any]
    ...
    func testInit_imageWithLightAndDarkModeUrl() {
        ...
        let data = [
            Constants.CardTemplate.UIElement.Image.URL: TestConstants.MOCK_URL,
            Constants.CardTemplate.UIElement.Image.DARK_URL: TestConstants.MOCK_DARK_URL
        ] as [String : Any]
    ...
    func testInit_imageWithInvalidLightUrl() {
        // setup
        let data = [
            Constants.CardTemplate.UIElement.Image.URL: 123,
        ] as [String : Any]
    ...
    func testInit_imageWithInvalidDarkUrl() {
        ...
        let data = [
            Constants.CardTemplate.UIElement.Image.URL: TestConstants.MOCK_URL,
            Constants.CardTemplate.UIElement.Image.DARK_URL: 123
        ] as [String : Any]
    ...
    func testInit_imageWithBundledResource() {
        // setup
        let data = [
            Constants.CardTemplate.UIElement.Image.BUNDLE: "image.jpg"
        ] as [String : Any]
    ...
    func testInit_imageWithLightAndDarkModeBundle() {
        ...
        let data = [
            Constants.CardTemplate.UIElement.Image.BUNDLE: "image.jpg",
            Constants.CardTemplate.UIElement.Image.DARK_BUNDLE: "darkimage.jpg"
        ] as [String : Any]
